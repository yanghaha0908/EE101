...
$sql = "SELECT *from 战舰 where 制造国='英国' and 分类 !='航空母舰' and 分类 !='巡洋舰' LIMIT $start_from, $num_rec_per_page";
...
<?php 
$sql = "SELECT *from 战舰 where 制造国='英国' and 分类 !='航空母舰' and 分类 !='巡洋舰'"; 
...
<div align="center">
<?php
echo "<a href='y q.php?page=1'>".'|<'."</a> "; // 第一页 
for ($i=1; $i<=$total_pages; $i++) { 
    echo "<span class='page-icon' class='h1'><a href='y q.php?page=".$i."'>".$i."</a> </span>";
    if ($i==23) {echo"<br><br>";}
}; 
echo "<a href='y q.php?page=$total_pages'>".'>|'."</a> "; // 最后一页
?>
  </div>
</div>
