...
<div class="layui-layout layui-layout-admin">
  ...
  <?php echo " <div class='layui-logo'>英国 $p</div>"; ?> 

    <ul class="layui-nav layui-layout-left">
    <li class="layui-nav-item"><a href="主页.html">主页</a></li>
      <li class="layui-nav-item"><a href="y g.php">概况</a></li>
      <li class="layui-nav-item"><a href="y x.php?m=巡洋舰">巡洋舰</a></li>
      <li class="layui-nav-item"><a href="y x.php?m=航空母舰">航空母舰</a></li>
      <li class="layui-nav-item"><a href="y q.php?">其他</a></li>
...
<!-- 内容主体区域 -->
  ...
  <style>
    body{
        background-image: url("../a/ying.jpg");
...
$sql = "SELECT *from 战舰 where 制造国='英国' and 分类 ='$p' LIMIT $start_from, $num_rec_per_page";
...
<?php 
$sql = "SELECT * FROM 战舰 where 制造国 ='英国' and 分类='$p'";
...
<div align="center">
<?php
echo "<a href='y x.php?m=$p&page=1'>".'|<'."</a> "; // 第一页 
for ($i=1; $i<=$total_pages; $i++) { 
    echo "<span class='page-icon' class='h1'><a href='y x.php?m=$p&page=".$i."'>".$i."</a> </span>";
    if ($i==23) {echo"<br><br>";}
}; 
echo "<a href='y x.php?m=$p&page=$total_pages'>".'>|'."</a> "; // 最后一页
?>
  </div>
</div>
    ...
    series: [
        {
            ...
            type: 'bar',
            data: [<?php   
                    if ($p=='巡洋舰'){echo 153.79;}
                    elseif($p=='航空母舰'){echo 207.20;}
                    else{echo 0;}
                    ?>, 
                    <?php   
                    if ($p=='巡洋舰'){echo 153.79;}
                    elseif($p=='航空母舰'){echo 208.63;}
                    else{echo 0;}
                    ?>, 
                    <?php   
                    if ($p=='巡洋舰'){echo 0;}
                    elseif($p=='航空母舰'){echo 202.36;}
                    else{echo 0;}
                    ?>, 
                    <?php   
                    if ($p=='巡洋舰'){echo 0;}
                    elseif($p=='航空母舰'){echo 292.00;}
                    else{echo 0;}
                    ?>]
        }
    ]
    ...
    series: [
        {
            ...
            data: [<?php   
                    if ($p=='巡洋舰'){echo 18.51;}
                    elseif($p=='航空母舰'){echo 26.55;}
                    else{echo 0;}
                    ?>, 
                    <?php   
                    if ($p=='巡洋舰'){echo 18.51;}
                    elseif($p=='航空母舰'){echo 27.31;}
                    else{echo 0;}
                    ?>, 
                    <?php   
                    if ($p=='巡洋舰'){echo 0;}
                    elseif($p=='航空母舰'){echo 32.60;}
                    else{echo 0;}
                    ?>, 
                    <?php   
                    if ($p=='巡洋舰'){echo 0;}
                    elseif($p=='航空母舰'){echo 38.60;}
                    else{echo 0;}
                    ?>]
        }
    ]
    ...
    series: [
        {
            ...
            data: [<?php   
                    if ($p=='巡洋舰'){echo 25.84;}
                    elseif($p=='航空母舰'){echo 26.56;}
                    else{echo 0;}
                    ?>, 
                    <?php   
                    if ($p=='巡洋舰'){echo 25.84;}
                    elseif($p=='航空母舰'){echo 26.44;}
                    else{echo 0;}
                    ?>, 
                    <?php   
                    if ($p=='巡洋舰'){echo 0;}
                    elseif($p=='航空母舰'){echo 28.25;}
                    else{echo 0;}
                    ?>, 
                    <?php   
                    if ($p=='巡洋舰'){echo 0;}
    ...
    series: [
        {
            ...
            type: 'bar',
            data: [<?php   
                    if ($p=='巡洋舰'){echo 15947.68;}
                    elseif($p=='航空母舰'){echo 21403.50;}
                    else{echo 0;}
                    ?>, 
                    <?php   
                    if ($p=='巡洋舰'){echo 15947.68;}
                    elseif($p=='航空母舰'){echo 22915.90;}
                    else{echo 0;}
                    ?>, 
                    <?php   
                    if ($p=='巡洋舰'){echo 0;}
                    elseif($p=='航空母舰'){echo 24200.00;}
                    else{echo 0;}
                    ?>, 
                    <?php   
                    if ($p=='巡洋舰'){echo 0;}
                    elseif($p=='航空母舰'){echo 65000.00;}
                    else{echo 0;}
                    ?>]
        }
    ]
