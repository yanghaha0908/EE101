...
<div class="layui-layout layui-layout-admin">
  ...
  <?php echo " <div class='layui-logo'>其他类别</div>"; ?> 
    ...
    <li class="layui-nav-item"><a href="主页.html">主页</a></li>
      ...
      <li class="layui-nav-item"><a href="us q.php?m=航空母舰">其他</a></li>
...
$sql = "SELECT *from 战舰 where 制造国='美国' and 分类!='航空母舰' and 分类 !='战列舰' LIMIT $start_from, $num_rec_per_page";
...
<?php 
$sql = "SELECT *from 战舰 where 制造国='美国' and 分类 !='航空母舰' and 分类 !='战列舰'"; 
...
<div align="center">
<?php
echo "<a href='us q.php?page=1'>".'|<'."</a> "; // 第一页 
for ($i=1; $i<=$total_pages; $i++) { 
    echo "<span class='page-icon' class='h1'><a href='us q.php?page=".$i."'>".$i."</a> </span>";
    if ($i==23) {echo"<br><br>";}
}; 
echo "<a href='us q.php?page=$total_pages'>".'>|'."</a> "; // 最后一页
?>
  </div>
</div>
