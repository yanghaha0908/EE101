...
$sql = "SELECT *from 战舰 where 制造国='中国' and 分类 !='护卫舰' and 分类 !='保障辅助舰艇' and 分类 !='常规潜艇'and 分类 !='驱逐舰'and 分类 !='巡逻舰/艇'LIMIT $start_from, $num_rec_per_page";
...
<?php 
$sql = "SELECT *from 战舰 where 制造国='中国' and 分类 !='护卫舰' and 分类 !='保障辅助舰艇' and 分类 !='常规潜艇'and 分类 !='驱逐舰'and 分类 !='巡逻舰/艇'"; 
...
<div align="center">
<?php
echo "<a href='c q.php?page=1'>".'|<'."</a> "; // 第一页 
for ($i=1; $i<=$total_pages; $i++) { 
    echo "<span class='page-icon' class='h1'><a href='c q.php?&page=".$i."'>".$i."</a> </span>";
    if ($i==23) {echo"<br><br>";}
}; 
echo "<a href='c q.php?&page=$total_pages'>".'>|'."</a> "; // 最后一页
?>
  </div>
</div>
